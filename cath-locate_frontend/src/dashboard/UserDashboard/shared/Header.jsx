  ...
  return (
    <div className='xs:bg-white xs:h-16 xs:px-4 xs:flex xs:justify-between xs:items-center xs:border xs:border-gray-200'>
        <div className='xs:relative'>
            ...
            <input type="search" name="search" placeholder='Search...' className='xs:text-sm xs:focus:outline-none xs:active:outline-none xs:h-10 xs:w-[130px] lg:w-[240px] xs:border border-gray-300 xs:px-4 xs:rounded-sm xs:pl-10 xs:pr-4 ' />
        </div>
